...
-- DESC: Create all 9 raw tables for Olist E-Commerce dataset
-- RUN:  Execute in pgAdmin Query Tool on olist_db database
-- ============================================================
...
-- 2. Geolocation Dataset (No Primary Key — zip codes repeat)
...
CREATE TABLE olist_products_dataset (
    ...
    product_name_lenght         INTEGER,   -- original Kaggle typo kept intentionally
    product_description_lenght  INTEGER,   -- original Kaggle typo kept intentionally
